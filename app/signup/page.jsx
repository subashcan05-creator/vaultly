      ...
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          <div className="w-16 h-16 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-4">
            <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="#2F6B4F" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/>
            </svg>
          </div>
          <h1 className="text-xl font-bold text-[#1B2A4A] mb-2">Check your email</h1>
          <p className="text-sm text-black/50 mb-6">
            We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.
          </p>
          <a href="/login" className="text-sm font-semibold text-[#C98A2C] hover:underline">Back to login</a>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-black/8 rounded-2xl shadow-sm p-8">
          <h1 className="text-xl font-bold text-[#1B2A4A] mb-1">Create your account</h1>
          <p className="text-sm text-black/45 mb-6">Free forever · No credit card required</p>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-black/50 mb-1">Full name</label>
              <input
                type="text"
                required
                value={fullName}
                onChange={e => setFullName(e.target.value)}
                placeholder="Subash Chan"
            ...
            <div>
              <label className="block text-xs font-medium text-black/50 mb-1">Password</label>
              <input
                type="password"
                required
                value={password}
          ...
          <p className="text-xs text-black/35 text-center mt-5 leading-relaxed">
        ...
        <p className="text-center text-sm text-black/45 mt-6">
          ...
          <a href="/login" className="text-[#1B2A4A] font-semibold hover:underline">Sign in</a>
        </p>
      </div>
    </div>
  );
